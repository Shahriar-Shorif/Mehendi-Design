package com.handdesign.mehndidesign;

import static com.handdesign.mehndidesign.services.Constant.ABOUT_URL;
import static com.handdesign.mehndidesign.services.Constant.CONTACT_URL;
import static com.handdesign.mehndidesign.services.Constant.POLICY_URL;
import static com.handdesign.mehndidesign.services.Constant.getAdSize;
...
import com.handdesign.mehndidesign.adapter.CategoryAdapter;
import com.handdesign.mehndidesign.adapter.SliderAdapter;
import com.handdesign.mehndidesign.model.Design;
...
//            adContainerView.setVisibility(View.VISIBLE);
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if(item.getItemId() == R.id.share) {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW).setData(Uri.parse(ABOUT_URL)));
            }
            return false;
        });
    }
